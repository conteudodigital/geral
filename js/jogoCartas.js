var appCartas = function (itens, botoes, idCanvas) {
    ...
    var botoesArray = [];
    var botoes = [{ imagem: 'opt1.png' }, { imagem: 'opt2.png' }];
    var gui;
    var i_acertos = 0;
    var i_erros = 0;
    var txt_a;
    ...
    function fase(qual) {
        ...
        for (i = 0; i < botoes.length; i++) {
            ...
            botoesArray[i].x = tamanhoCartaW * i * 1.1 + 230;
            botoesArray[i].y = -450;
                ...
                for (index in botoesArray) {
                    if (collisionDetect(this, botoesArray[index])) {
                        if (this.name == botoesArray[index].name) {
                            ...
                            botoesArray[index].sobreposicao += 50;
