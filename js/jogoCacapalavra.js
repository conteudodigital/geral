...
function gameCacaPalavras(words,temDica) {
...
function animaTitulo(texto){
	...
	var txt = new createjs.Text(texto, "bold 60px VAG Rounded BT", "#ffc000");
	txt.regY=60;
	...
	tit.x=-300;
	tit.y=80;
    createjs.Tween.get(tit).to({x:640},300,createjs.Ease.backOut).wait(1500).to({x:1500},300,createjs.Ease.backIn).call(deletaTitulo);
}
