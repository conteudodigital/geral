var AppCorrida=function(idCanvas,_itens,tamanhoBt,margemBt,margemPergunta,espacamento,ativaTempo,_tempoPergunta,tamanhoTextoBotao,pontosNecessarios,mostraTutorial,_naoembaralhar){
	...
	function init2() {
		...
		btinicia.on("click", function() {
			...
			for(var i=0;i<3;i++){
				...
				carrosBt[i] = new createjs.Bitmap(caminho+"carro"+i+".png");
